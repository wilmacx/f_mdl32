...
<?php
/*
$ip = gethostbyname('moodle.alveriagroup.com');
$serverdata=unserialize(file_get_contents('http://www.geoplugin.net/php.gp?ip='.$ip)); 
//echo $serverdata['geoplugin_countryCode'];
echo $serverdata['geoplugin_continentCode'];
*/
?>
