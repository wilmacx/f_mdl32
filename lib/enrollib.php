 ...
 * @return array
 */
function enrol_get_my_courses($fields = NULL, $sort = 'visible DESC,sortorder ASC', $limit = 0, $cat = NULL) {
    global $DB, $USER;
	...
	//ADD BY WM 06/07/16 x nascondere corsi ad utenti non iscritti (aggiunto  $cat = NULL sulla chiamata e variabile wcat sulla query riga 622 - modificato anche file course/renderer.php riga 1401)
	if (empty($cat)) {
		$wcat = "";
	} else {
		//if ($cat==9){
			$wcat= "and c.category=".$cat;
		//}
	}		
