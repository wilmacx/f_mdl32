...
function glossary_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    if ($filearea === 'attachment' or $filearea === 'entry') {
        ...
        //send_stored_file($file, 0, 0, true, $options); // download MUST be forced - security! //REM BY WM 310117 X forzare aperture e non download img
		send_stored_file($file, 0, 0, false, $options); // download MUST be forced - security! //ADD BY WM 310117 X forzare aperture e non download img
